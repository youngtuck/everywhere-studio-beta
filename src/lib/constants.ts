...
export const OUTPUT_TYPES = {
  ...
  freestyle: {
    label: "Freestyle",
    description: "Open conversation with Reed. No deliverable assumed. You think out loud, Reed thinks with you.",
    types: [
      { id: "freestyle", name: "Freestyle", format: "Varies", shortDesc: "Thought partner mode. No format required. Output on request only." },
    ],
  },
};
...
export const OUTPUT_TYPES_FULL: Record<string, { label: string; description: string; types: Array<{ id: string; name: string; what: string; reed: string; format: string; delivery: string; notFit: string }> }> = {
  content: {
    ...
    types: [
      ...
      { id: "freestyle", name: "Freestyle", what: "Open conversation with Reed. No format required. No deliverable assumed. You think out loud, Reed thinks with you.", reed: "Reed follows your lead. He asks questions, pushes back on weak premises, and reflects what he's hearing. He does not propose a structure or move toward production unless you ask. At a natural stopping point he asks: 'Do you want to capture any of this?'", format: "Whatever you need. If something worth keeping emerges, Reed helps you shape it. If nothing needs to be saved, the session is complete.", delivery: "On request only. No automatic outline. No forced next step. If you want an output, Reed asks what form it should take.", notFit: "You already know what you're building. Pick the output type." },
    ],
  },
  social: {
    label: "Social",
